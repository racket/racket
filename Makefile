...
SRC_CATALOG = "https://download.racket-lang.org/releases/7.9/catalog/"
DOC_SEARCH = 
SERVER = localhost
SERVER_PORT = 9440
...
fetch-pb-from:
	...
	if [ ! -d racket/src/ChezScheme/boot/pb ] ; 	  then git clone -q -b v7.9 $(PB_REPO) racket/src/ChezScheme/boot/pb ; 	  else cd racket/src/ChezScheme/boot/pb && git fetch -q origin v7.9:remotes/origin/v7.9 ; fi
	cd racket/src/ChezScheme/boot/pb && git checkout -q v7.9
pb-stage:
	cd racket/src/ChezScheme/boot/pb && git branch v7.9
	cd racket/src/ChezScheme/boot/pb && git checkout v7.9
	cd racket/src/ChezScheme/boot/pb && git add . && git commit --amend -m "new build"
pb-push:
	cd racket/src/ChezScheme/boot/pb && git push -u origin v7.9
win-cs-base:
