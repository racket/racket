...
SRC_CATALOG = "https://download.racket-lang.org/releases/8.1/catalog/"
DOC_SEARCH = 
SERVER = localhost
SERVER_PORT = 9440
...
pb-stage:
	cd racket/src/ChezScheme/boot/pb && git branch v8.1
	cd racket/src/ChezScheme/boot/pb && git checkout v8.1
	cd racket/src/ChezScheme/boot/pb && git add . && git commit --amend -m "new build"
pb-push:
	cd racket/src/ChezScheme/boot/pb && git push -u origin v8.1
win-cs-base:
