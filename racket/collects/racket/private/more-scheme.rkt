...
(module more-scheme '#%kernel
  (#%require "define-et-al.rkt" "core-syntax.rkt" "core-syntax.rkt" "define.rkt" '#%paramz "case.rkt" "logger.rkt"
             (for-syntax '#%kernel "stx.rkt" "define-et-al.rkt" "core-syntax.rkt" "core-syntax.rkt" "stxcase-scheme.rkt" "qqstx.rkt"))
