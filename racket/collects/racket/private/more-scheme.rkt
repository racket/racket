...
(module more-scheme '#%kernel
  ...
  (define-values (struct:break-parameterization
                  make-break-parameterization
                  break-parameterization?
                  break-parameterization-ref
                  break-parameterization-set!)
    (make-struct-type 'break-parameterization #f 1 0 #f null 'current))

  (define-values (break-parameterization-cell)
    (make-struct-field-accessor break-parameterization-ref 0 'cell))

  (define-values (set-break-paramz-ref-cell!)
    (make-struct-field-mutator break-parameterization-set! 0 'cell))
