                          ...
                          (if (eq? tmp_2 'eos)
                            ...
                            (if (eqv? tmp_2 '#\x7d)
                              (let ((app_0 (reverse$1 accum_0)))
                                (values app_0 (add1 pos_2)))
                              (let ((app_0
                                     (cons (chytes-ref$1 s_0 pos_2) accum_0)))
                                (loop_0 app_0 (add1 pos_2))))))))))
                   (loop_0 null next-pos_0)))
                (lambda (l_0 pos2_0)
                  (let ((categories_0
                         (let ((tmp_2 (list->bytes l_0)))
                           (let ((index_0
                                  (hash-ref hash2956 tmp_2 (lambda () 0))))
       ...
       (if (zero? delta1_0)
         ...
         (let ((app_0
           ...
           (cons
            app_0
            (reverse$1
             (let ((vec_0 state5_0) (len_0 (unsafe-vector-length state5_0)))
               (letrec*
                ((for-loop_0
                  (|#%name|
                   for-loop
   ...
   (lambda (delta7_0 in9_0 ms-pos10_0 me-pos11_0 state12_0)
     (let ((app_0
       ...
       (cons
        ...
        (if state12_0
          (reverse$1
           (let ((vec_0 state12_0) (len_0 (unsafe-vector-length state12_0)))
             (letrec*
              ((for-loop_0
                (|#%name|
                 for-loop
     ...
     (let ((string-offset_0
       ...
       (let ((app_0
         ...
         (cons
          ...
          (if state23_0
            (reverse$1
             (let ((vec_0 state23_0) (len_0 (unsafe-vector-length state23_0)))
               (letrec*
                ((for-loop_0
                  (|#%name|
                   for-loop
   ...
   (lambda (delta25_0 bstr-in27_0 ms-pos28_0 me-pos29_0 state30_0)
     (let ((app_0
       ...
       (cons
        ...
        (if state30_0
          (reverse$1
           (let ((vec_0 state30_0) (len_0 (unsafe-vector-length state30_0)))
             (letrec*
              ((for-loop_0
                (|#%name|
                 for-loop
               ...
               (let ((app_0
                 ...
                 (cons
                  ...
                  (if state_0
                    (reverse$1
                     (let ((vec_0 state_0)
                           (len_0 (unsafe-vector-length state_0)))
                       (letrec*
                        ((for-loop_0
                          (|#%name|
                           for-loop
         ...
         (if ms-pos_0
           (let ((app_0 (subbytes in_0 ms-pos_0 me-pos_0)))
             (cons
              ...
              (if state_0
                (reverse$1
                 (let ((vec_0 state_0) (len_0 (unsafe-vector-length state_0)))
                   (letrec*
                    ((for-loop_0
                      (|#%name|
                       for-loop
