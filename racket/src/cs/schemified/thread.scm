...
(define cell.1$7 (unsafe-make-place-local initial-place-root-custodian))
...
(define set-root-custodian!
  (lambda (c_0)
    (begin
      (unsafe-place-local-set! cell.1$7 c_0)
...
(define 1/unsafe-make-custodian-at-root
  (|#%name|
   ...
   (lambda () (1/make-custodian (unsafe-place-local-ref cell.1$7)))))
...
(define poll-custodian-will-executor
  (lambda ()
    (let ((c1_0
           (|#%app| host:will-try-execute (unsafe-place-local-ref cell.1$4))))
      (if c1_0
        (begin
...
(define custodian-shutdown-root-at-exit
  (lambda ()
    (begin
      (start-atomic)
      (begin0
        (do-custodian-shutdown-all (unsafe-place-local-ref cell.1$7) #t)
        (end-atomic)))))
  ...
  (let ((thread-push-kill-callback!_0
         (|#%name|
          ...
          (lambda (cb22_0 t-in21_0)
            (let ((t_0 (if t-in21_0 t-in21_0 (current-thread/in-atomic))))
         ...
         (|#%name|
          ...
          (lambda (secs37_0)
            (begin
              ...
              (if (if (zero? secs37_0) (zero? (current-atomic)) #f)
                (thread-yield #f)
                (let ((until-msecs_0
      ...
      (if (eq? t_0 check-t_0)
        (begin
          ...
          (if (in-atomic-mode?)
            ...
            (void)))
        (if (eqv? 0 (current-atomic)) (future-exit-barrier) (void))))))
(define break>?
  (lambda (k1_0 k2_0)
    (if (eq? k1_0 'break)
      #f
                       ...
                       (let ((temp38_0 (future*-id f6_0)))
                         (let ((temp39_0
                           ...
                           (let ((temp38_1 temp38_0) (temp37_1 temp37_0))
                             (log-future.1 #f temp39_0 temp37_1 temp38_1)))))
                     (let ((temp40_0 (if as-unblock?3_0 'sync 'result)))
                       (let ((temp41_0 (future*-id f6_0)))
                         (log-future.1 #f #f temp40_0 temp41_0))))
                   (void))
                 (void))
               (begin
                 (if (eq? (future*-kind f6_0) 'was)
                   ...
                   (let ((temp43_0 (future*-id f6_0)))
                     (log-future.1 #f #f 'start-work temp43_0)))
                 (let ((finish!_0
                        (|#%name|
                         finish!
                          ...
                          (lambda results_0
                            (if (eq? (future*-state f6_0) 'running)
                              (begin
                                ...
                                (let ((temp47_0 (future*-id f6_0)))
                                  (log-future.1 #f #f 'end-work temp47_0)))
                              (void))))
                         (dynamic-wind
                          (lambda () (void))
                          (lambda ()
                      ...
                      (let ((break-enabled_0 (current-break-enabled-cell)))
                        (let ((thunk-in-prompt_0
                          ...
                          (let ((me-f_0
                            ...
                            (let ((th_0
                                   (let ((temp59_0 (object-name thunk11_0)))
                                     (let ((temp64_0
                                            (lambda ()
                                              (letrec*
                                               ((loop_0
               ...
               (if (let ((cf_0 (1/current-future)))
                 ...
                 (begin
                   ...
                   (call-with-values
                    (lambda () (1/touch f_0))
                    (lambda results_0
                      (begin (future-exit-barrier) (apply values results_0)))))
                 (if (eq? s_0 'blocked)
                   (if (current-future-in-future-thread)
       ...
       (unsafe-call-with-composable-continuation/no-wind
        (lambda (k_0)
          (begin
            ...
            (if touching-f16_0
              (let ((temp88_0 (future*-id me-f_0)))
                (let ((temp89_0 (future*-id touching-f16_0)))
                  (log-future.1 temp89_0 #f 'touch temp88_0)))
              (void))
            (if (future*-kind me-f_0)
              (void)
              (let ((temp91_0 (future*-id me-f_0)))
                (log-future.1 #f #f 'suspend temp91_0)))
            (if reschedule13_0
              (|#%app| reschedule13_0)
              (if (future*-kind me-f_0)
                (begin
...
(define future-sync
  (lambda (who_0 thunk_0)
    (begin
      ...
      (let ((me-f_0 (1/current-future)))
        (if (not me-f_0)
          (begin (end-future-uninterrupted) (|#%app| thunk_0))
          (if (eq? (future*-kind me-f_0) 'would-be)
            (begin
              ...
              (let ((v_0 (|#%app| thunk_0)))
                (begin
                  (let ((temp98_0 (future*-id me-f_0)))
                    (log-future.1 #f #f 'result temp98_0))
                   ...
                   (lambda ()
                     (begin
                       (let ((temp100_0 (future*-id me-f_0)))
                         (log-future.1 #f who_0 'sync temp100_0))
                       (let ((v_0 (|#%app| thunk_0)))
                         (begin
                           (let ((temp103_0 (future*-id me-f_0)))
                             (log-future.1 #f #f 'result temp103_0))
                           v_0))))))))))))))
        ...
        (let ((e_0
          ...
          (begin
            ...
            (let ((temp115_0 (future*-id f_0)))
              (log-future.1 #f #f 'end-work temp115_0))
            (1/current-future 'worker)
