...
(define-primitive-table kernel-table
  ...
  [char-extend? (known-procedure/folding 2)]
  ...
  [char-grapheme-cluster-step (known-procedure/no-prompt/multi 4)]
  ...
  [string-grapheme-cluster-count (known-procedure/no-prompt 14)]
  [string-grapheme-cluster-length (known-procedure/no-prompt 12)]
