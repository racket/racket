...
(define-primitive-table kernel-table
  ...
  [call-with-input-file (known-procedure/no-prompt 12)]
  [call-with-output-file (known-procedure/no-prompt 28)]
  ...
  [open-input-output-file (known-procedure/no-prompt 14)]
  ...
  [split-path (known-procedure/no-prompt 2)]
  ...
  [unquoted-printing-string? (known-procedure/no-prompt 2)]
  [values (known-procedure/no-prompt -1)] ; not marked as pure, because it is not single valued
