...
;; Maps a property-predicate function to `(cons predicate-proc struct-property)`:
...
(define (do-struct-type-property-predicate-procedure? v spt)
  (and (procedure? v)
       (let* ([v (strip-impersonator v)]
...
(define/who struct-type-property-predicate-procedure?
  (case-lambda
   [(v) (do-struct-type-property-predicate-procedure? v #f)]
   [(v spt) (do-struct-type-property-predicate-procedure? v spt)]))
