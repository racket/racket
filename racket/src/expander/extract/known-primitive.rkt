...
(define (register-known-primitives! seen-defns)
  ...
  (hash-set! seen-defns 'procedure-realm (known-function-of-satisfying '(procedure)))
  (hash-set! seen-defns 'object-name (known-function 1 #t)) ; assuming no `prop:object-name`
  (hash-set! seen-defns 'procedure-rename (known-function-of-satisfying '(procedure symbol symbol)))
