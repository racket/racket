...
#define scheme_raise_realm_exn (scheme_extension_table->scheme_raise_realm_exn)
...
#define scheme_wrong_contract_for_realm (scheme_extension_table->scheme_wrong_contract_for_realm)
...
#define scheme_uchar_graphbreaks_table (scheme_extension_table->scheme_uchar_graphbreaks_table)
...
#define scheme_extract_cc_mark_list (scheme_extension_table->scheme_extract_cc_mark_list)
...
#define scheme_is_hash_table_equal_always (scheme_extension_table->scheme_is_hash_table_equal_always)
...
#define scheme_is_hash_tree_equal_always (scheme_extension_table->scheme_is_hash_tree_equal_always)
...
#define p (scheme_extension_table->p)
