...
scheme_init_port_fun(Scheme_Startup_Env *env)
{
  ...
  ADD_NONCM_PRIM("open-output-file",         open_output_file,       1, 5, env);
  ...
  ADD_NONCM_PRIM("open-input-output-file",   open_input_output_file, 1, 5, env);
  ...
  ADD_PRIM_W_ARITY2("call-with-output-file", call_with_output_file,  2, 6, 0, -1, env);
  ADD_PRIM_W_ARITY2("call-with-input-file",  call_with_input_file,   2, 3, 0, -1, env);
  ADD_PRIM_W_ARITY2("with-output-to-file",   with_output_to_file,    2, 6, 0, -1, env);
