...
enum {
  ...
  scheme_thunk_for_continue_type,       /* 187 */
  ...
  scheme_rt_pipe,                       /* 214 */
  scheme_rt_system_child,               /* 215 */
  scheme_rt_tcp,                        /* 216 */
  scheme_rt_write_data,                 /* 217 */
  scheme_rt_tcp_select_info,            /* 218 */
  scheme_rt_param_data,                 /* 219 */
  scheme_rt_will,                       /* 220 */
  ...
  scheme_rt_letrec_check_frame,         /* 254 */
#endif
