...
(define-symbol-flags* ([libraries] [flags primitive proc])
  ...
  (string-grapheme-cluster-count [sig [(string) -> (uptr)] [(string sub-index) -> (uptr)] [(string sub-index sub-index) -> (uptr)]] [flags true])
  (string-grapheme-cluster-length [sig [(string sub-index) -> (uptr)] [(string sub-index sub-index) -> (uptr)]] [flags true])
