...
(define-symbol-flags* ([libraries (rnrs) (rnrs arithmetic flonums)] [flags primitive proc])
  ...
  (no-infinities-violation? [sig [(ptr) -> (boolean)]]  [pred sub-condition] [flags pure unrestricted mifoldable discard])
  (make-no-nans-violation [sig [() -> (condition)]] [flags pure unrestricted alloc])
  (no-nans-violation? [sig [(ptr) -> (boolean)]] [pred sub-condition] [flags pure unrestricted mifoldable discard])
...
(define-symbol-flags* ([libraries (rnrs) (rnrs conditions)] [flags primitive proc])
  ...
  (condition? [sig [(ptr) -> (boolean)]] [pred condition] [flags pure unrestricted mifoldable discard])
  ...
  (message-condition? [sig [(ptr) -> (boolean)]]  [pred message-condition][flags pure unrestricted mifoldable discard])
  ...
  (warning? [sig [(ptr) -> (boolean)]] [pred sub-condition] [flags pure unrestricted mifoldable discard])
  (make-serious-condition [sig [() -> (condition)]] [flags pure unrestricted alloc])
  (serious-condition? [sig [(ptr) -> (boolean)]] [pred sub-condition] [flags pure unrestricted mifoldable discard])
  ...
  (violation? [sig [(ptr) -> (boolean)]] [pred sub-condition] [flags pure unrestricted mifoldable discard])
  (make-assertion-violation [sig [() -> (condition)]] [flags pure unrestricted alloc])
  (assertion-violation? [sig [(ptr) -> (boolean)]] [pred sub-condition] [flags pure unrestricted mifoldable discard])
  (make-irritants-condition [sig [(ptr) -> (condition)]] [flags pure unrestricted alloc])
  (irritants-condition? [sig [(ptr) -> (boolean)]]  [pred irritants-condition] [flags pure unrestricted mifoldable discard])
  ...
  (who-condition? [sig [(ptr) -> (boolean)]] [pred who-condition] [flags pure unrestricted mifoldable discard])
  ...
  (non-continuable-violation? [sig [(ptr) -> (boolean)]] [pred sub-condition] [flags pure unrestricted mifoldable discard])
  (make-implementation-restriction-violation [sig [() -> (condition)]] [flags pure unrestricted alloc])
  (implementation-restriction-violation? [sig [(ptr) -> (boolean)]] [pred sub-condition] [flags pure unrestricted mifoldable discard])
  (make-lexical-violation [sig [() -> (condition)]] [flags pure unrestricted alloc])
  (lexical-violation? [sig [(ptr) -> (boolean)]] [pred sub-condition] [flags pure unrestricted mifoldable discard])
  (make-syntax-violation [sig [(ptr ptr) -> (condition)]] [flags pure unrestricted alloc])
  (syntax-violation? [sig [(ptr) -> (boolean)]] [pred syntax-violation] [flags pure unrestricted mifoldable discard])
  ...
  (undefined-violation? [sig [(ptr) -> (boolean)]] [pred sub-condition] [flags pure unrestricted mifoldable discard])
)
...
(define-symbol-flags* ([libraries (rnrs) (rnrs files) (rnrs io ports) (rnrs io simple)] [flags primitive proc])
  ...
  (i/o-error? [sig [(ptr) -> (boolean)]] [pred sub-condition] [flags pure unrestricted mifoldable discard])
  (make-i/o-read-error [sig [() -> (condition)]] [flags pure unrestricted alloc])
  (i/o-read-error? [sig [(ptr) -> (boolean)]] [pred sub-condition] [flags pure unrestricted mifoldable discard])
  (make-i/o-write-error [sig [() -> (condition)]] [flags pure unrestricted alloc])
  (i/o-write-error? [sig [(ptr) -> (boolean)]] [pred sub-condition] [flags pure unrestricted mifoldable discard])
  (make-i/o-invalid-position-error [sig [(ptr) -> (condition)]] [flags pure unrestricted alloc])
  (i/o-invalid-position-error? [sig [(ptr) -> (boolean)]] [pred sub-condition] [flags pure unrestricted mifoldable discard])
  ...
  (i/o-filename-error? [sig [(ptr) -> (boolean)]] [pred sub-condition] [flags pure unrestricted mifoldable discard])
  ...
  (i/o-file-protection-error? [sig [(ptr) -> (boolean)]] [pred sub-condition] [flags pure unrestricted mifoldable discard])
  (make-i/o-file-is-read-only-error [sig [(ptr) -> (condition)]] [flags pure unrestricted alloc])
  (i/o-file-is-read-only-error? [sig [(ptr) -> (boolean)]] [pred sub-condition] [flags pure unrestricted mifoldable discard])
  (make-i/o-file-already-exists-error [sig [(ptr) -> (condition)]] [flags pure unrestricted alloc])
  (i/o-file-already-exists-error? [sig [(ptr) -> (boolean)]] [pred sub-condition] [flags pure unrestricted mifoldable discard])
  (make-i/o-file-does-not-exist-error [sig [(ptr) -> (condition)]] [flags pure unrestricted alloc])
  (i/o-file-does-not-exist-error? [sig [(ptr) -> (boolean)]] [pred sub-condition] [flags pure unrestricted mifoldable discard])
  (make-i/o-port-error [sig [(ptr) -> (condition)]] [flags pure unrestricted alloc])
  (i/o-port-error? [sig [(ptr) -> (boolean)]] [pred sub-condition] [flags pure unrestricted mifoldable discard])
...
(define-symbol-flags* ([libraries] [flags primitive proc])
  ...
  (continuation-condition? [sig [(ptr) -> (boolean)]]  [pred continuation-condition] [flags pure unrestricted mifoldable discard])
  ...
  (format-condition? [sig [(format-condition) -> (boolean)]] [pred format-condition] [flags pure unrestricted mifoldable discard])
  ...
  (sort! [sig [(procedure list) -> (list)]] [flags true])
  (source-condition? [sig [(ptr) -> (boolean)]] [pred source-condition] [flags pure unrestricted mifoldable discard])
  ...
  (thread-condition? [feature pthreads] [sig [(ptr) -> (boolean)]] [pred sub-condition] [flags pure unrestricted mifoldable discard])
...
(define-symbol-flags* ([libraries] [flags system proc]) ; system procedures
  ...
  ($compound-condition? [sig [(ptr) -> (boolean)]] [pred sub-condition] [flags pure unrestricted mifoldable])
  ...
  ($recompile-condition? [sig [(ptr) -> (boolean)]] [pred sub-condition] [flags pure unrestricted mifoldable])
  ...
  ($src-condition? [sig [(ptr) -> (boolean)]] [pred sub-condition] [flags pure unrestricted mifoldable])
