...
void scheme_add_binding(Scheme_Object *sym, Scheme_Object *phase, Scheme_Object *_marks,
                        Scheme_Object *val)
{
 ...
 */
  ...
  scheme_add_binding(localname, phase, SCHEME_VEC_ELS(mc)[0], elem);
}
                                              ...
                                              int save_unmarshal)
{
  ...
  scheme_add_binding(NULL, phase, (Scheme_Object *)marks, pes);
}
