...
After adding these lines, evaluating @racket[(enter! "serve.rkt")] and
@racket[(define stop (serve 8081))], opening
@tt{http://localhost:8081/hello} should produce the old greeting.
