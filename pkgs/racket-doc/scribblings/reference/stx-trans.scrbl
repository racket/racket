...
@history[#:changed "6.3" @elem{Added the @racket[add-scope?] argument,
                               ...
                               no longer necessary.}
         #:changed "8.2.0.6" @elem{Added the @tech{outside-edge scope} and @tech{use-site scope}
                                   tracking behaviors.}]}
...
@history[#:changed "6.90.0.27" @elem{Added the @racket[extra-intdef-ctxs] argument.}
         #:changed "8.2.0.6" @elem{Changed the return value from @racket[void] to the list of bound identifiers.}]}
...
@history[#:added "6.3"
         #:changed "8.2.0.6" @elem{Added the optional
