...
(parameterize ([current-contract-namespace
  ...
  (test-flat-contract 'positive-integer? 1 0)
  (test-flat-contract 'positive-integer? 1.0 -1)
  (test-flat-contract 'positive-integer? 3 0.0)
  (test-flat-contract 'negative-integer? -5 0)
  (test-flat-contract 'negative-integer? -1.0 2)
  (test-flat-contract 'nonnegative-integer? 0 -1)
  (test-flat-contract 'nonnegative-integer? 0.0 0.5)
  (test-flat-contract 'nonnegative-integer? 5/5 5/3)
  (test-flat-contract 'nonnegative-integer? -0.0 -5)
  (test-flat-contract 'nonpositive-integer? 0 5)
  (test-flat-contract 'nonpositive-integer? -0.0 -1.2)
  (test-flat-contract 'nonpositive-integer? -2.0 0.1)
