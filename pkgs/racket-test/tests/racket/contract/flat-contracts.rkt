...
(parameterize ([current-contract-namespace
  ...
  (test-flat-contract 'positive-integer/c 1 0)
  (test-flat-contract 'positive-integer/c 1.0 -1)
  (test-flat-contract 'positive-integer/c 3 0.0)
  (test-flat-contract 'negative-integer/c -5 0)
  (test-flat-contract 'negative-integer/c -1.0 2)
  (test-flat-contract 'nonnegative-integer/c 0 -1)
  (test-flat-contract 'nonnegative-integer/c 0.0 0.5)
  (test-flat-contract 'nonnegative-integer/c 5/5 5/3)
  (test-flat-contract 'nonnegative-integer/c -0.0 -5)
  (test-flat-contract 'nonpositive-integer/c 0 5)
  (test-flat-contract 'nonpositive-integer/c -0.0 -1.2)
  (test-flat-contract 'nonpositive-integer/c -2.0 0.1)
