...
(define (subtype-tests)
  (subtyping-tests
   ...
   ;; evts
   [(make-NonHandleEvt t1) (make-NonHandleEvt t2)]
   [FAIL (make-NonHandleEvt -Byte) (make-NonHandleEvt -String)]
   [-Semaphore (make-NonHandleEvt -Semaphore)]
   [FAIL -Semaphore (make-NonHandleEvt -Int)]
   [-Output-Port (make-NonHandleEvt -Output-Port)]
   [FAIL -Output-Port (make-NonHandleEvt -Int)]
   [-Input-Port (make-NonHandleEvt -Input-Port)]
   [FAIL -Input-Port (make-NonHandleEvt -Int)]
   [-TCP-Listener (make-NonHandleEvt -TCP-Listener)]
   [FAIL -TCP-Listener (make-NonHandleEvt -Int)]
   [-Thread (make-NonHandleEvt -Thread)]
   [FAIL -Thread (make-NonHandleEvt -Int)]
   [-Subprocess (make-NonHandleEvt -Subprocess)]
   [FAIL -Subprocess (make-NonHandleEvt -Int)]
   [-Will-Executor (make-NonHandleEvt -Will-Executor)]
   [FAIL -Will-Executor (make-NonHandleEvt -Int)]
   [(make-CustodianBox -String)
    (make-NonHandleEvt (make-CustodianBox -String))]
   [FAIL (make-CustodianBox -String) (make-NonHandleEvt -String)]
   [(-channel -String) (make-NonHandleEvt -String)]
   [FAIL (-channel -String) (make-NonHandleEvt -Int)]
   [FAIL (make-HandleEvt -Int) (make-NonHandleEvt -Int)]
   [FAIL (make-NonHandleEvt -Int) (make-HandleEvt -Int)]
