...
(define (-HT a b) (Un (make-IHashtable a b) (make-MHashtable a b)))
(define -IHT make-IHashtable)
(define -MHT make-MHashtable)
(define/decl -BoxTop (make-BoxTop))
(define/decl -ChannelTop (make-ChannelTop))
(define/decl -IHashTop (make-IHashtableTop))
(define/decl -MHashTop (make-MHashtableTop))
(define/decl -HashTop (Un -IHashTop -MHashTop))
