#;
#<<END
TR opt: unboxed-let-functions6.rkt 31:13 z -- unbox float-complex
TR opt: unboxed-let-functions6.rkt 31:15 0.0+1.0i -- unboxed literal
TR opt: unboxed-let-functions6.rkt 31:10 (+ z 0.0+1.0i) -- unboxed binary float complex
...
TR opt: unboxed-let-functions6.rkt 32:21 (car l) -- float-arg-expr in complex ops
TR opt: unboxed-let-functions6.rkt 32:16 (+ z (car l)) -- unboxed binary float complex
