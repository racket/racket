...
TR opt: unboxed-exp.rkt 30:39 (real-part p) -- complex accessor elimination
TR opt: unboxed-exp.rkt 31:50 p -- unbox float-complex
TR opt: unboxed-exp.rkt 31:39 (imag-part p) -- complex accessor elimination
TR opt: unboxed-exp.rkt 33:30 2.0+3.4i -- unboxed literal
TR opt: unboxed-exp.rkt 33:25 (exp 2.0+3.4i) -- unboxed unary float complex
TR opt: unboxed-exp.rkt 34:30 0.0+0.0i -- unboxed literal
TR opt: unboxed-exp.rkt 34:25 (exp 0.0+0.0i) -- unboxed unary float complex
