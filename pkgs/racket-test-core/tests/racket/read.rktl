...
(err/rt-test (readstr "#hashequalw") exn:fail:read:eof?)
...
(test #t eq? (readstr "#hashequalw()") (hashequalw))
...
(test-ht (readstr "#hashequalw((1 . 2))") 1 #f 1 2)
...
(test-ht (readstr "#hashequalw((\"apple\" . 1))") 1 #f "apple" #f)
...
;; NOTE: these strings produced by the `read` are mutable! so not equal-always?
(test-ht (readstr "#hashequalw((\"apple\" . 1) (\"apple\" . 10))") 2 #f "apple" #f)
(test-ht (readstr "#hash((apple . 1) (apple . 10))") 1 #f 'apple 10)
(test-ht (readstr "#hasheq((apple . 1) (apple . 10))") 1 #t 'apple 10)
(test-ht (readstr "#hasheqv((apple . 1) (apple . 10))") 1 #f 'apple 10)
(test-ht (readstr "#hashequalw((apple . 1) (apple . 10))") 1 #f 'apple 10)
