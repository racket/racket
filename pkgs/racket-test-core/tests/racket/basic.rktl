...
(hash-tests make-hash make-hasheq make-hasheqv make-hashequalw
            make-weak-hash make-weak-hasheq make-weak-hasheqv make-weak-hashequalw
            make-ephemeron-hash make-ephemeron-hasheq make-ephemeron-hasheqv make-ephemeron-hashequalw
            hash-ref hash-set! hash-ref! hash-update! hash-has-key?
            hash-remove! hash-count
...
(test #t hash-equal-always? (make-weak-hashequalw))
...
(let ([mk (lambda (mk)
  ...
  (test #t equal? (mk make-hashequalw) (mk make-hashequalw))
  (test #f equal? (mk make-hash) (mk make-hasheq))
  (test #f equal? (mk make-hash) (mk make-hasheqv))
  (test #f equal? (mk make-hash) (mk make-hashequalw))
  (test #f equal? (mk make-hasheq) (mk make-hasheqv))
  (test #f equal? (mk make-hasheq) (mk make-hashequalw))
  (test #f equal? (mk make-hasheqv) (mk make-hashequalw))
  ...
  (test #f equal? (mk make-hashequalw) (mk make-weak-hashequalw))
  ...
  (test #f equal? (mk make-hashequalw) (mk make-ephemeron-hashequalw))
  ...
  (test #f equal? (mk make-weak-hashequalw) (mk make-ephemeron-hashequalw)))
(let ([mk (lambda (mk)
            (mk `((1 . 2))))])
  ...
  (test #t equal? (mk make-immutable-hashequalw) (mk make-immutable-hashequalw))
  ...
  (test #f equal? (mk make-immutable-hash) (mk make-immutable-hashequalw))
  (test #f equal? (mk make-immutable-hasheq) (mk make-immutable-hasheqv))
  (test #f equal? (mk make-immutable-hasheq) (mk make-immutable-hashequalw))
  (test #f equal? (mk make-immutable-hasheqv) (mk make-immutable-hashequalw)))
...
(let ([check-subset (lambda (mk1 mk2 [v2 2] #:k1 [k1 'a] #:k2 [k2 'a])
  ...
  (check-subset hashequalw hashequalw)
  (check-subset hashequalw hashequalw #:k1 (cons 1 2) #:k2 (cons 1 2))
  ...
  (check-subset hashequalw (make-make-hash make-hashequalw))
  (check-subset hashequalw (make-make-hash make-weak-hashequalw))
  (check-subset hashequalw (make-make-hash make-ephemeron-hashequalw))
...
(let ([not-same-comparison? (lambda (x)
  ...
  (err/rt-test (hash-keys-subset? #hash() #hashequalw()) not-same-comparison?)
  (err/rt-test (hash-keys-subset? #hasheq() #hasheqv()) not-same-comparison?)
  (err/rt-test (hash-keys-subset? #hasheq() #hashequalw()) not-same-comparison?)
  (err/rt-test (hash-keys-subset? #hasheqv() #hashequalw()) not-same-comparison?)
...
(arity-test make-immutable-hashequalw 0 1)
