...
(define (mutable-treelist-tests small-treelist wrap)
  ...
  (test! (treelist 0 "a" 'b '#:c 'x 'y 'z)
         mutable-treelist-append!
         small-treelist (treelist 'x 'y 'z))
  (test! (treelist 0 "a" 'b '#:c 'x 'y 'z)
         (λ (mtl m/tl) (mutable-treelist-append! mtl m/tl #:at-end? #t))
         small-treelist (treelist 'x 'y 'z))
  (test! (treelist 'x 'y 'z 0 "a" 'b '#:c)
         (λ (mtl m/tl) (mutable-treelist-append! mtl m/tl #:at-end? #f))
         small-treelist (treelist 'x 'y 'z))
