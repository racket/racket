#hash((__x
      ...
      ((let () (define-syntax-rule (ok x) x) (ok 5))
       ...
       ((start-top . #f)
            ...
            (s1
             ...
             (s1
                  ...
                  (s7
                   ...
                   (s7
                    ...
                    ((s5
                      ...
                      (s7
                       (s8 s6)
                       (s1 ((s11 (s10 s6))) (s12 s11 (s13 (s14 s6)) s11))
                       #f))
                     (s14 s6))
                    #f)
                   #f))
              ...
              (s7
               ...
               (s1
                ((s15 s4))
                (s16 (((s17) (s18 0 (s19 s15)))) () (s20 (s21 s3 s17))))
               (s1
                ((s4 ((s5 (s6) s9) s2)))
                (s7
                 s4
                 (s1 () (s16 () () (s22 s3 (s23 (s17)))))
                 (s24 #f #:opaque s2)))))))
         .
         #s(stx-boundary
            (s1
        ...
        (track-syntax
         s0
         #s(stx-boundary (s1 ((s2 (s3 (s4 s5) s6))) (s7 s8)))
         .
         #s(stx-boundary (s1 ((s2 (s3 (s4 s5) s6))) (s7 s8))))
        (macro-post-x
      ...
      ((module m racket/base (define (proc x) x) (provide proc))
       ...
       ((start-top . #f)
        ...
        (next . #f)
        (enter-prim . #s(stx-boundary (s0 (s1 (s2 s3)))))
        (prim-provide . #s(stx-boundary (s0 (s1 (s2 s3)))))
        (visit . #s(stx-boundary (s0 s1)))
        (resolve . #s(stx-boundary s0))
        (enter-macro #s(stx-boundary (s0 s1)) . #s(stx-boundary (s0 s1)))
        (macro-pre-x . #s(stx-boundary (s0 s1)))
