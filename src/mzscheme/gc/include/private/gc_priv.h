...
/* PLTSCHEME: add __DARWIN_UNIX03 test */
...
# define GC_push_conditional(b, t, all) GC_push_all(b, t)
				...
				/* on the third arg.			*/
/* PLTSCHEME: GC_API */
GC_API void GC_push_all_stack (ptr_t b, ptr_t t);
...
/* PLTSCHEME: GC_API */
	GC_API void GC_push_finalizer_structures(void);
	GC_API void GC_push_stubborn_structures (void);
#	ifdef THREADS
