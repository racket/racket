;;; soegaard 21-Feb-2006, PLT 301

;;; Sebastian Egner's original comprehensions.ss patched to
;;; handle let-values, let-match and let-plt-match in do-ec. 

; Modifications:
;   do-ec:do   
;     Now support let-values and let-match
...
(module |comprehensions| mzscheme
  ...
  (define-syntax-globally :parallel-1  ; used as 
    (syntax-rules (:do let)
