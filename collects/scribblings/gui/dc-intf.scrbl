...
@defmethod[(set-background [color (or/c (is-a?/c color%) string?)])
           void?]{
...
@defmethod[(set-text-background [color (or/c (is-a?/c color%) string?)])
           void?]{
...
@defmethod[(set-text-foreground [color (or/c (is-a?/c color%) string?)])
           void?]{
