...
(parameterize ([current-namespace (make-base-namespace)]
  ...
  (let* ([struct:rock (eval 'struct:rock)]
    ...
    (when (extflonum-available?)
      ...
      (bin-exact 16.920151004054307787t0 'extflexpt 3.1t0 2.5t0 #t)
...
(when (extflonum-available?)
  (let ()
    ...
    ;; TODO Does not work when enabled extfl unboxing, probably due to 3m gc
    ;;(test-values '(-100001.0t0 100001.0t0) non-tail)
    ;;(test -2200000.0t0 non-tail2)
