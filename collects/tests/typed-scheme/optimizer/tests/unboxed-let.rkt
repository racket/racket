#;
(
unboxed-let.rkt line 38 col 14 - t1 - unbox float-complex
unboxed-let.rkt line 38 col 17 - 3.0+6.0i - unboxed literal
unboxed-let.rkt line 38 col 12 - - - unboxed binary float complex
unboxed-let.rkt line 38 col 11 - (#%app - t1 (quote 3.0+6.0i)) - unboxed float complex
unboxed-let.rkt line 37 col 14 - 1.0+2.0i - unboxed literal
unboxed-let.rkt line 37 col 23 - 2.0+4.0i - unboxed literal
unboxed-let.rkt line 37 col 12 - + - unboxed binary float complex
...
unboxed-let.rkt line 40 col 5 - t2 - unbox float-complex
unboxed-let.rkt line 40 col 8 - t3 - unbox float-complex
unboxed-let.rkt line 40 col 3 - + - unboxed binary float complex
unboxed-let.rkt line 40 col 2 - (#%app + t2 t3) - unboxed float complex
