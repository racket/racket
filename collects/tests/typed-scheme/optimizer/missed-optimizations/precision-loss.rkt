...
precision-loss.rkt 24:3 (#%app * (quote 3/4) (quote 2/3)) -- exact arithmetic subexpression inside a float expression, extra precision discarded -- caused by: 24:0 (#%app + (#%app * (quote 3/4) (quote 2/3)) (quote 2.0))
precision-loss.rkt 26:1 + -- binary float
precision-loss.rkt 28:1 + -- binary float
precision-loss.rkt 28:3 (#%app - (quote 3/4)) -- exact arithmetic subexpression inside a float expression, extra precision discarded -- caused by: 28:0 (#%app + (#%app - (quote 3/4)) (quote 2.0))
...
precision-loss.rkt 36:8 (#%app * (quote 3/4) (quote 2/3)) -- exact arithmetic subexpression inside a float expression, extra precision discarded -- caused by: 36:0 (#%app * (#%app * (quote 3/4) (quote 2/3)) (quote 2.0))
2.5
2.75
1.25
2.5
