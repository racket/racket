...
(test stx-bound-id=? #'((a b) () ())
      (let ()
        ...
        (lookup-sig-mac x)))
(let ()
  (define-signature super (s1 (define-values (s2 s3) s4) (define-syntaxes (s5 s6) s7)))
  (test stx-bound-id=? #'((s1 a b f) (((s2 s3) . s4) ((c d) . e) ((i) . j)) (((s5 s6) . s7) ((g) . h)))
        (let ()
...
(let ()
  (define-signature super (s1 (define-values (s2 s3) s4) (define-syntaxes (s5 s6) s7)))
  (let ((a 1) (g 2) (j 3) (s1 4) (s2 5) (s7 6))
    (test stx-bound-id=? #'(((#f . s1) a b f) ((((#f . s2) s3) . s4) ((c d) . e) ((i) . j)) (((s5 s6) . (#f . s7)) ((g) . h)))
          (let ()
            (define-signature x extends super (a b (define-values (c d) e) f
                                                 (define-syntaxes (g) h)
                                                 (define-values (i) j)))
