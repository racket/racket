...
public final class Double extends Number implements Comparable
{
   ...
   * infinity.
   */
  public static final double NEGATIVE_INFINITY =  getNegInf(); //-1.0 / 0.0;

  /**
   * The value of a double representing 1.0/0.0, positive infinity.
   */
  public static final double POSITIVE_INFINITY =  getPosInf(); //1.0 / 0.0;

  /**
   * All IEEE 754 values of NaN have the same value in Java.
   */
  public static final double NaN = getNaN(); //0.0 / 0.0;

  private static native double getNegInf();
  private static native double getPosInf();
